  ...
  return (
    <div className="flex flex-col gap-6 border-b border-line pb-10 sm:flex-row sm:items-end sm:justify-between">
      <div>
        ...
        <h1 className="mt-3 text-display-sm sm:text-display-md">Antonia Afxentiou</h1>
        <p className="mt-2 text-lg text-ink-soft">UX/UI Designer</p>
        <p className="mt-3 max-w-xl text-ink-soft">
          Junior UX/UI Designer with hands-on experience in user research, wireframing, prototyping, and
          responsive UI design, gained through an internship at Air Balloon Digital Studio and self-directed
          project work. Looking for a junior role to keep building on that foundation.
        </p>
